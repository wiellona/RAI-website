                ...
                <div className="max-w-4xl w-full mx-auto px-4 py-12">
                    <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
                        <div className="bg-[#511715] text-white p-6">
                            <h1 className="text-2xl font-bold">RAI University Registration</h1>
                            <p className="text-white/80 mt-2">Register your university for the Responsible AI Global University Ranking</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 md:p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    <label htmlFor="universityName" className="block text-sm font-medium text-gray-900 mb-1">
                                        University Name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                {/* Director Name */}
                                <div className="md:col-span-2">
                                    <label htmlFor="directorName" className="block text-sm font-medium text-gray-900 mb-1">
                                        Director Name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                {/* Status/Relation */}
                                <div className="md:col-span-2">
                                    <label htmlFor="statusRelation" className="block text-sm font-medium text-gray-900 mb-1">
                                        Status/Relation
                                    </label>
                                    <select
                                        id="statusRelation"
                                ...
                                <div className="md:col-span-2">
                                    <label htmlFor="officialLetter" className="block text-sm font-medium text-gray-900 mb-1">
                                    ...
                                    <div 
                                        ...
                                        onClick={() => document.getElementById('officialLetter').click()}
                                    >
                                    ...
                                    {formData.officialLetter && (
                                        <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-md">
                                            ...
                                            <p className="text-xs text-green-600 mt-1">
                                                Size: {(formData.officialLetter.size / 1024 / 1024).toFixed(2)} MB
                                            </p>
                                        </div>
                                    )}
                                </div>
