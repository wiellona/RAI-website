  ...
  return (
    <AuthGuard>
      <div className="bg-[#FAF9F6] min-h-screen py-10">
        <Container>
          <div className="space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-[#5C2E2E]">{uni.name}</h1>
                <p className="text-gray-700 mt-2">{uni.country} • {uni.region}</p>
              </div>
              <div className="text-left sm:text-right">
                <div className="text-sm text-gray-600">Last updated</div>
                <div className="font-medium text-gray-900">{formatDate(uni.lastUpdated)}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={m.label} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  <div className="text-sm font-medium text-gray-600">{m.label}</div>
                  <div className="mt-2 text-3xl font-bold text-[#5C2E2E]">{m.value}</div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <div className="text-lg font-semibold text-[#5C2E2E]">#{uni.rank}</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-bold text-[#5C2E2E]">Methodology Snapshot</h2>
