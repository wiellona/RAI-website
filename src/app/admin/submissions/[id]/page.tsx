  ...
  const handleAccept = async () => {
    ...
    const confirmed = confirm(
      `Are you sure you want to APPROVE "${
        submission.university?.name || "this submission"
      }"? This will set is_approved to true in Profiles table.`
    );
    if (!confirmed) return;
  ...
  const handleDecline = async () => {
    ...
    const confirmed = confirm(
      `Are you sure you want to REJECT "${
        submission.university?.name || "this submission"
      }"? This will set is_approved to false in Profiles table.`
    );
    if (!confirmed) return;
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {submission.university.website && (
                  <div>
                    ...
                    <p className="text-lg text-gray-900">
                      <a
                        href={submission.university.website}
                        target="_blank"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {submission.university.pic_email && (
                    <div>
                      ...
                      <p className="text-lg text-gray-900">
                        <a
                          href={`mailto:${submission.university.pic_email}`}
                          className="text-[#0047AB] hover:underline"
                        >
                          {submission.university.pic_email}
                        </a>
            ...
            <div className="bg-white border-2 border-[#0047AB]/20 rounded-lg shadow-sm p-8 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">
                    {submission.questionnaire.version}
                  </p>
                </div>
          ...
          <div className="mt-8 p-4 bg-gradient-to-r from-[#f0f4ff] to-white border-2 border-[#0047AB]/30 rounded-lg">
            <p className="text-sm text-[#000080]">
              <strong>Note:</strong> This is a frontend demo with mock data. No
              database connection required. Click the action buttons above to
              simulate approval/decline actions.
            </p>
          </div>
        </div>
      </Container>
